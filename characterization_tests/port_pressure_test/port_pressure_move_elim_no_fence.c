...
void port_pressure_alu(int n_alu) {
    ...
    for (uint64_t i = 0; i < ITERS; i++) {
        ...
        // eliminatable mov (same-reg renaming pattern)
        asm volatile(
            "mov %1, %0\n\t"
            : "+r"(a)
            : "r"(b)
...
// ----------------------------------------
// LOAD pressure + eliminatable MOV
// ----------------------------------------
__attribute__((noinline))
...
// ----------------------------------------
// STORE pressure + eliminatable MOV
// ----------------------------------------
__attribute__((noinline))
